...
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_TQ3 = 0.0060f;
    ...
    for (int i = 0; i < GGML_TYPE_COUNT; i++) {
        ...
        if (qfns_cpu->from_float && qfns->to_float) {
            ...
            const float max_quantization_error =
                ...
                type == GGML_TYPE_TQ3_1S  ? MAX_QUANTIZATION_TOTAL_ERROR_TQ3 :
                type == GGML_TYPE_TQ3_0   ? MAX_QUANTIZATION_TOTAL_ERROR_TQ3 :
            ...
            const float max_allowed_error = type == GGML_TYPE_Q2_K || type == GGML_TYPE_IQ2_XS || type == GGML_TYPE_IQ2_XXS ||
                                            ...
                                            false // type == GGML_TYPE_TQ3_1S
                                          ? MAX_DOT_PRODUCT_ERROR_LOWBIT
                                          : type == GGML_TYPE_Q1_0
                                          ? MAX_DOT_PRODUCT_ERROR_BINARY
                                          : type == GGML_TYPE_TQ1_0 || type == GGML_TYPE_TQ2_0 || type == GGML_TYPE_TQ3_0 ||  type == GGML_TYPE_TQ3_1S
